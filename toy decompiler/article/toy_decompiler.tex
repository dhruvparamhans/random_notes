...
\newcommand{\TITLE}{Toy decompiler for x86-64 written in Python}
...
\lstinputlisting{fahr_raw.txt}

Neat:

\lstinputlisting{fahr_neat.txt}
...
\lstinputlisting{align2grain.txt}
...
\lstinputlisting{fahr_to_celsius_obf1.txt}
